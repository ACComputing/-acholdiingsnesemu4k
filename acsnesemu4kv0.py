...
PROJECT_README = r"""
AC'S SNES Emu 0.2 — Real SNES Emulator
======================================

A single-file SNES emulator in Python + Cython: 65816 CPU core, basic LoROM/HiROM
mapper support, and a Tkinter GUI.

Current status
--------------
Early alpha: CPU runs many opcodes, ROM loading and title detection work, simple
colored output and basic input. Not yet capable of running commercial games.
...
- Basic PPU placeholder (pattern + red button overlay)
- Threaded ~60 FPS emulation loop
- ROM header parsing (title, mapper)
...
- Cython — CPU core
- NumPy — framebuffer
- Pillow (PIL) / ImageTk — rendering
- Tkinter — GUI

How to run
----------
Install dependencies (use the same interpreter you run the app with)::

    python3.14 -m pip install --upgrade pip
    python3.14 -m pip install cython numpy pillow

Run::

    python3.14 ac_snes_emu_0.2.py

Pip package names are also in module constant REQUIREMENTS.
